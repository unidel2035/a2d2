class CreateLlmUsageSummaries < ActiveRecord::Migration[8.1]
  def change
    ...
    unless table_exists?(:llm_usage_summaries)
      create_table :llm_usage_summaries do |t|
      ...
      add_index :llm_usage_summaries, [ :provider, :model, :date ], unique: true, name: "index_llm_usage_on_provider_model_date"
      add_index :llm_usage_summaries, :date
    end
  end
end

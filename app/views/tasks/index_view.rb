...
module Tasks
  class IndexView < ApplicationComponent
    def initialize(tasks:, stats:, robots:, current_status: nil, current_robot_id: nil)
      @tasks = tasks
      @stats = stats
      @robots = robots
    ...
    def view_template
      div(class: "container mx-auto px-4 py-8") do
        h1(class: "text-3xl font-bold mb-6") { "Управление заданиями роботов" }
    ...
    def render_stats_cards
      div(class: "grid grid-cols-1 md:grid-cols-6 gap-4 mb-8") do
        render_stat_card("Всего заданий", @stats[:total], "bg-white")
        render_stat_card("Запланировано", @stats[:planned], "bg-blue-50", "text-blue-600")
        ...
        render_stat_card("Отменено", @stats[:cancelled], "bg-gray-50", "text-gray-600")
        ...
        form(method: "get", action: tasks_path, class: "grid grid-cols-1 md:grid-cols-3 gap-4") do
          ...
          div do
            ...
            select(
              ...
              option(value: "planned", selected: @current_status == "planned") { "Запланировано" }
    ...
    def render_tasks_table
      div(class: "bg-white rounded-lg shadow") do
        div(class: "px-6 py-4 border-b border-gray-200") do
          h2(class: "text-xl font-semibold") { "Список заданий" }
        end
            ...
            table(class: "min-w-full divide-y divide-gray-200") do
              thead(class: "bg-gray-50") do
                tr do
                  ...
                  th(class: "px-6 py-3 text-left text-xs font-medium text-gray-500 uppercase tracking-wider") { "Оператор" }
    ...
    def render_task_row(task)
      tr(class: "hover:bg-gray-50") do
        ...
        td(class: "px-6 py-4 whitespace-nowrap text-sm") do
          task.operator ? task.operator.email : "Не назначен"
        end
